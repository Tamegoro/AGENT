...
namespace JapaneseDontHurry
{
    public class JapaneseDontHurry
    {
        ...
        static Font fontYasashisaGothicBoldDayOfWeek10 = Resources.GetFont(Resources.FontResources.YasashisaGothicBoldDayOfWeek10);
        ...
        static void UpdateTime(object state)
        {
            ...
            if (showDigital == false)
            {
                ...
                stringDay = "日";
                _point = _azmdrawing.FindPointDegreeDistance(degreeDay, screenCenterX, screenCenterY, screenCenterX - MARGIN_EDGE_DISK - THIKNESS_RIM - (fontDay.Height / 2) - 3);
