    ...
    public class ZigZag
    {
        ...
        static void UpdateTime(object state)
        {
            ...
            if (showDigital == false)
            {
                ...
                _display.DrawEllipse(colorForeground, 1, _point.X, _point.Y, 2, 2, colorBackground, 0, 0, colorBackground, 0, 0, 255);
                _display.DrawEllipse(colorBackground, 1, _point.X, _point.Y, 1, 1, colorForeground, 0, 0, colorForeground, 0, 0, 255);
