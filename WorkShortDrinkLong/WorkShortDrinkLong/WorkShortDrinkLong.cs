...
namespace WorkShortDrinkLong
{
    public class WorkShortDrinkLong
    {
        ...
        const int WORK_HOUR = 90;
        const int FREE_HOUR = 270;
        ...
        const int DISPLAY_MODE_BLACK_SQUHAND = 1;
        const int DISPLAY_MODE_BLACK_POIHAND = 2;
        const int DISPLAY_MODE_BLACK_FRAHAND_DISK = 3;
        const int DISPLAY_MODE_BLACK_SQUHAND_DISK = 4;
        const int DISPLAY_MODE_BLACK_POIHAND_DISK = 5;
        const int DISPLAY_MODE_WHITE_FRAHAND = 6;
        const int DISPLAY_MODE_WHITE_SQUHAND = 7;
        const int DISPLAY_MODE_WHITE_POIHAND = 8;
        const int DISPLAY_MODE_WHITE_FRAHAND_DISK = 9;
        const int DISPLAY_MODE_WHITE_SQUHAND_DISK = 10;
        const int DISPLAY_MODE_WHITE_POIHAND_DISK = 11;
